...
public class EntityAICustomNearestAttackableTarget extends EntityAITarget
{
    private final Class targetClass;
    private final int targetChance;
    /** Instance of EntityAICustomNearestAttackableTargetSorter. */
    private final EntityAICustomNearestAttackableTarget.Sorter theNearestAttackableTargetSorter;
    /**
    ...
    public EntityAICustomNearestAttackableTarget(EntityCreature p_i1663_1_, Class p_i1663_2_, int p_i1663_3_, boolean p_i1663_4_)
    {
        this(p_i1663_1_, p_i1663_2_, p_i1663_3_, p_i1663_4_, false);
    }

    public EntityAICustomNearestAttackableTarget(EntityCreature p_i1664_1_, Class p_i1664_2_, int p_i1664_3_, boolean p_i1664_4_, boolean p_i1664_5_)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        {
            double d0 = hungryZombiesConfig.ZOMBIEHUNTDISTANCE;
